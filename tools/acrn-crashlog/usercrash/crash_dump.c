...
static int log_dump(int pid, int tgid, char *comm, int sig, int out_fd)
{
	...
	snprintf(commands, sizeof(commands), GET_K_STACK, pid);
	system_status(commands);

	_LOG(out_fd, "\nMaps:\n\n");
	memset(commands, 0, sizeof(commands));
	snprintf(commands, sizeof(commands), GET_MAPS, pid);
	system_status(commands);

	_LOG(out_fd, "\nOpen files:\n\n");
	memset(commands, 0, sizeof(commands));
	snprintf(commands, sizeof(commands), GET_OPEN_FILES, pid);
	system_status(commands);
	...
	snprintf(commands, sizeof(commands), GET_GDB_INFO, param);
	system_status(commands);
...
void crash_dump(int pid, int sig, int out_fd)
{
	...
	snprintf(commands, sizeof(commands), GET_COMM, pid);
	...
	memset(commands, 0, sizeof(commands));
	snprintf(commands, sizeof(commands), GET_TID, pid);
